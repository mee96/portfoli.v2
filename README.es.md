...
<div align="center">
<img src="docs/screenshots/plate.png" width="85%" alt="Plate map — rejilla interactiva de 96 pocillos"/>

<sub><b>Fig. 1</b> — La Placa: proyecto <code>B2</code> (BBT) seleccionado, con su stack, descripción y enlaces.</sub>
</div>

<div align="center">
<img src="docs/screenshots/bunsen-chat.png" width="40%" alt="Widget de chat de Bunsen abierto, en plena conversación"/>

<sub><b>Fig. 2</b> — Bunsen, el secretario de IA, respondiendo en streaming sobre un WebSocket en vivo.</sub>
</div>

<div align="center">
<img src="docs/screenshots/contact.png" width="85%" alt="Sección de contacto con formulario, foto, descarga de CV y redes sociales"/>

<sub><b>Fig. 3</b> — Formulario de contacto, descarga de CV según idioma y enlaces sociales.</sub>
</div>
